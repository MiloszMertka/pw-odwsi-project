...
public record LoginUserDto(
        ...
        @NotBlank(message = "Verification code cannot be blank") @Size(max = 255, message = "Verification code must not have more than 255 characters") String verificationCode
) {
