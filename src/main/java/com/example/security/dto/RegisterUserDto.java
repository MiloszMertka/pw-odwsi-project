...
public record RegisterUserDto(
        ...
        @NotBlank(message = "Email cannot be blank") @Size(max = 255, message = "Email must not have more than 255 characters") @Email(message = "Email is in wrong format") String email,
